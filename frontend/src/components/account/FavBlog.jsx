            ...
            <main className="flex-1">
              <div className="space-y-6">
                <div className="bg-white shadow rounded-lg p-6">
                  <h3 className="text-xl font-semibold text-gray-900 mb-6">Favorite Articles</h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <article className="group cursor-pointer">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900 mb-3 group-hover:text-gray-600">A Relentless Pursuit of Perfection in Product Design</h3>
                    ...
                    <article className="group cursor-pointer">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900 mb-3 group-hover:text-gray-600">How to Run a Successful Business With Your Partner</h3>
                      <p className="text-gray-600 line-clamp-2">
                    ...
                    <article className="group cursor-pointer">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900 mb-3 group-hover:text-gray-600">Why Food Matters — Disease Prevention & Treatment</h3>
                      <p className="text-gray-600 line-clamp-2">
                        Eating more plants and less meat has been tied to a longer life and a reduced risk of cardiovascular disease in a new study. Learn more about the benefits.
                      </p>
                    </article>
                  </div>
                </div>
